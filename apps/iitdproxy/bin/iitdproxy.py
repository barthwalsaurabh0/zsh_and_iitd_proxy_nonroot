...
class Proxy:
	...
	def __init__(self, username, password, proxy_cat):
		...
		if proxy_cat == "research":
			self.proxy_page_address = 'https://xen03.iitd.ac.in/cgi-bin/proxy.cgi'
		else:
	...
	def is_connected(self):
		if self.proxy_cat == "research":
			proxies = {'http': 'http://xen03.iitd.ac.in:3128'}
		else:
...
if __name__=="__main__":
	n = len(sys.argv)
	if n==1:
		print "\n\nUsage: python iitdproxy.py file" #username password proxy_category\n\n"
	else:
